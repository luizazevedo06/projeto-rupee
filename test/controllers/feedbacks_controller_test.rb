...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { bug: @feedback.bug, projeto: @feedback.projeto, solucao: @feedback.solucao } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { bug: @feedback.bug, projeto: @feedback.projeto, solucao: @feedback.solucao } }
